  ...
  return (
    <div className="py-0 px-2.5 pb-25">
      <div className="max-w-2xl my-20 mx-auto flex flex-col items-center text-center gap-7.5">
        ...
        <form className="p-2 w-[80%] bg-white rounded-md text-xl flex items-center justify-between text-black gap-2.5">
          <input
      ...
      <div className="max-w-[800px] m-auto bg-gradient-to-b from-[#395332b7] to-[#8d6d62c4] rounded-2xl">
        <div className="grid grid-cols-[0.5fr_2fr_1fr_1fr_1.5fr] py-4 px-5 items-center border-b border-gray-400">
          <p>#</p>
          <p>Coins</p>
          <p>Price</p>
        ...
        {displayCoin.slice(0, 10).map((item, index) => (
          <div
            className="grid grid-cols-[0.5fr_2fr_1fr_1fr_1.5fr] py-4 px-5 items-center border-b border-gray-400 last:border-b-0"
            key={index}
          >
